...
from keras.layers import Conv1D, MaxPooling1D, Flatten, Dense, Dropout, Input, Concatenate, MultiHeadAttention
...
#pro highres je multiattention, pro lowres je standardni attention
#moc nefunguje, model se neuci
def Conv1DLSTM2InputsMHAtt_(input_shape, **params):
    """
    ...
    # MultiHeadAttention
    attention_output = MultiHeadAttention(num_heads=7, key_dim=50)(x1, x1)
    x1 = Flatten()(attention_output)
