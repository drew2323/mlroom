...
def Conv1D3Inputs_(input_shape, **params):
    custom_layers = {}
    ...
    # Additional input 2 and its layers
    additional_input2 = Input(shape=input_shape[2], name='additional_input2')
    x3 = Conv1D(filters=32, kernel_size=3, activation='relu')(additional_input2)
    ...
    model = Model(inputs=[main_input, additional_input1, additional_input2], outputs=output)
