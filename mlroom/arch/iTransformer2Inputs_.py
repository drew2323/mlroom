...
def iTransformer2Inputs(input_shape, **params):
    """
    ...
    input_ts2 = Input(shape=input_shape[1])
    
    # Project features if needed
    x1 = feature_projection(input_ts1, projection_dim)
    x2 = feature_projection(input_ts2, projection_dim)
    
    # Add positional encoding
    pos_encoding_1 = SinePositionEncoding()(x1)
    pos_encoding_2 = SinePositionEncoding()(x2)
    
    x1 = pos_encoding_1 + x1
    x2 = pos_encoding_2 + x2
...
input_shape_2 = (sequence_length_2, num_features_2)
