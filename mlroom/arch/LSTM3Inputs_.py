...
def LSTM3Inputs_(input_shape, **params):
    ...
    input_shape_high_res, input_shape_low_res, input_shape_lowest_res = input_shape
    ...
    lstm_lowest_res = layers.LSTM(32, dropout=0.2, recurrent_dropout=0.2, kernel_regularizer=l2(l2_reg))(input_lowest_res)
